...
const dict = {
  ...
  // Profile / sign-in (backend = Go API)
  authWelcome: { zh: "欢迎使用 Keep Fit", en: "Welcome to Keep Fit" },
  authSubtitle: {
    zh: "用邮箱和密码区分不同用户。无后端：密码用 PBKDF2 哈希后只存在你这台设备上。",
    en: "Email + password isolates accounts on this device. No backend — passwords are PBKDF2-hashed locally.",
  },
  authSubtitleBackend: {
    zh: "用邮箱和密码登录。数据保存在服务器，换设备也能看到。",
    en: "Sign in to sync your workouts and history across devices.",
  },
  authBackendNote: {
    zh: "数据保存在我们的服务器上。删除账号会一并清空。",
    en: "Your data lives on our server. Deleting your account wipes it.",
  },
  authEmailTaken: { zh: "这个邮箱已经注册过了", en: "This email is already registered" },
  authWrongCredentials: { zh: "邮箱或密码不对", en: "Wrong email or password" },
  authEmailLabel: { zh: "邮箱", en: "Email" },
  authPasswordLabel: { zh: "密码", en: "Password" },
  authPasswordConfirmLabel: { zh: "再输一次密码", en: "Confirm password" },
  authContinue: { zh: "继续", en: "Continue" },
  authNext: { zh: "下一步", en: "Next" },
  authSignIn: { zh: "登录", en: "Sign in" },
  authSignUp: { zh: "注册", en: "Sign up" },
  authChangeEmail: { zh: "换个邮箱", en: "Use a different email" },
  authInvalidEmail: { zh: "邮箱格式不对", en: "Invalid email" },
  authPasswordTooShort: { zh: "密码至少 6 位", en: "Password must be at least 6 characters" },
  authPasswordMismatch: { zh: "两次输入的密码不一致", en: "Passwords don't match" },
  authWrongPassword: { zh: "密码不对", en: "Incorrect password" },
  authWelcomeBack: { zh: "欢迎回来", en: "Welcome back" },
  authWelcomeBackSub: { zh: "输入密码继续", en: "Enter your password to continue" },
  authCreateAccount: { zh: "创建新账户", en: "Create your account" },
  authCreateAccountSub: { zh: "这个邮箱还没注册过，设个密码就行", en: "This email is new — set a password to register" },
  authNeedsPasswordSetup: { zh: "这个账户还没设密码", en: "This account has no password yet" },
  authNeedsPasswordSetupSub: { zh: "为了保护你的数据，请现在设一个密码", en: "Set a password now to lock down your data" },
  authSetPassword: { zh: "设置密码", en: "Set password" },
  authRecent: { zh: "之前用过的账户：", en: "Recent accounts:" },
  authNoBackendNote: {
    zh: "数据和密码哈希只存在你这台设备上。",
    en: "Your data and password hash never leave this device.",
  },
